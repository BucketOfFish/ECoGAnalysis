...
% Data Layer
% ---------------------------------------
N{1} = th_layerdata({'trainFile',trainLmdb,'testFile',testLmdb,'nClasses',10,'dataScale',256,'dataAdd',-128,'floorMode',true,'batchSize',128,'shuffleTrain',true});
...
P.train=propDefault(P.train,'firstTrainIter',2000); % for long test use 200000
