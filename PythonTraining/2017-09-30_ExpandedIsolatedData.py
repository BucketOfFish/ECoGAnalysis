...
def main(_):
    ...
    epochs = 150 # when to stop training
    delta = pow(10, -4)

    printoutPeriod = 100
    saveName = "expandedIsolatedGaussianNoiseDataset_tunedHyperparameters_FC3:200_batchSize200_useReducedDataTrue_weightGaussian"
