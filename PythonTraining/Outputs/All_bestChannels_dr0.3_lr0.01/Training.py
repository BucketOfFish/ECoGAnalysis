...
# saveName = "Consonants_bestChannels_dr0.3_lr0.01"
saveName = "All_bestChannels_dr0.3_lr0.01"
...
def Keras_train(args):
    ...
    model.add(Conv2D(32, kernel_size=(1,2), strides=(1,2), activation='relu', input_shape=(channels, timeSteps, 1)))
    # model.add(MaxPooling2D(pool_size=(2,1), strides=(1,1)))
    model.add(Dropout(dropoutRate))
    model.add(Conv2D(64, kernel_size=(1,3), strides=(1,3), activation='relu'))
    model.add(Dropout(dropoutRate))
    model.add(Conv2D(128, kernel_size=(1,43), strides=(1,43), activation='relu'))
    model.add(Dropout(dropoutRate))
    model.add(Flatten())
